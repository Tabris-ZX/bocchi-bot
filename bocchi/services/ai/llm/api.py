...
from bocchi.services.ai.core.models import ModelName
from bocchi.services.ai.core.options import (
    GenerationConfig,
    LLMEmbeddingConfig,
    TTSConfig,
)
from bocchi.services.ai.guardrails import GuardrailSource
...
async def embed(
    ...
    *,
    ...
    if not batch.payloads:
        from bocchi.services.ai.core.messages import UsageInfo
...
async def generate_structured(
    ...
    *,
    ...
    try:
        ...
        from bocchi.services.ai.core.engine.structured_parser import (
            BaseOutputProcessor,
        )
        from bocchi.services.ai.core.options import (
            OutputFormatConfig,
        ...
        from bocchi.services.ai.guardrails import parse_guardrails
        ...
        from bocchi.services.ai.capabilities.builtin import (
            ReflexionCapability,
        )
