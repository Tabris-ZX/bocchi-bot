...
from bocchi.services.ai.config import (
    ProviderConfig,
    get_ai_config,
    get_llm_config,
)
from bocchi.services.ai.core.exceptions import ConfigurationException
from bocchi.services.ai.core.models import ModelDetail
...
from bocchi.services.ai.llm.system.network import health_manager
...
async def get_model_instance(
    ...
    from bocchi.services.ai.llm.system.cache import get_or_create_model
...
def clear_all_cache() -> None:
    ...
    清空模型实例缓存与路由组解析缓存。
    """
    from bocchi.services.ai.llm.system.cache import clear_model_cache
