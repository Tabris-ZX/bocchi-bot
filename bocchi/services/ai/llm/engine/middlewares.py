...
from bocchi.services.ai.core.protocols.middleware import LLMMiddleware, NextCall
...
from bocchi.services.ai.llm.system.network import (
    HealthManager,
    LLMHttpClient,
)
...
_LLM_API_CACHE = SimpleMemoryCache(namespace="bocchi_llm_api_cache")
...
class LoggingMiddleware:
    ...
    async def __call__(
        ...
        if self.identity.api_type == "smart":
            from bocchi.services.ai.llm.adapters.factory import SmartAdapter
