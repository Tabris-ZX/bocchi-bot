from bocchi.services.ai.core.messages import EmbeddingRequest
from bocchi.services.ai.core.models import ModelIdentity
from bocchi.services.ai.core.options import LLMEmbeddingConfig
from bocchi.services.ai.llm.adapters.base import BaseAdapter, RequestData
from bocchi.services.ai.llm.adapters.handlers.openai_handlers import (
    OpenAIEmbeddingHandler,
    OpenAIRerankHandler,
)
from bocchi.services.ai.llm.adapters.openai import OpenAICompatAdapter
