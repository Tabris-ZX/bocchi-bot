...
from bocchi.services.ai.core.exceptions import ResponseParseException
...
from bocchi.services.ai.core.options import GenerationConfig, TTSConfig
from bocchi.services.ai.llm.adapters.base import BaseAdapter, RequestData
from bocchi.services.ai.llm.adapters.handlers.base import BaseAudioHandler
...
class MiniMaxAudioHandler(BaseAudioHandler):
    ...
    async def parse_speech_response(
        ...
        from bocchi.services.ai.core.messages import AudioResponse, UsageInfo
