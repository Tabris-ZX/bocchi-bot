...
from bocchi.services.ai.config import get_gemini_safety_threshold
...
from bocchi.services.ai.llm.adapters.base import (
    BaseAdapter,
    RequestData,
    ResponseData,
    process_image_data,
)
from bocchi.services.ai.llm.adapters.handlers.base import (
    BaseAudioHandler,
    ...
    async def convert_messages_async(
        ...
        for msg in messages:
            ...
            if isinstance(msg, SystemMessage):
                ...
                from bocchi.services.ai.core.messages import ToolReturnPart
...
class GeminiToolSerializer(ToolSerializer):
    def sanitize_schema(self, schema: dict[str, Any]) -> dict[str, Any]:
        from bocchi.services.ai.llm.engine.schema_transformer import (
...
class GeminiEmbeddingHandler(BaseEmbeddingHandler):
    ...
    async def prepare_embedding_request(
        ...
        from bocchi.services.ai.llm.adapters.handlers.gemini_handlers import (
