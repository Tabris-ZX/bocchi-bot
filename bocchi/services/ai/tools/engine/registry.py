...
from bocchi.services.ai.core.protocols.tool import (
    ToolExecutable,
    ToolProvider,
)
from bocchi.services.ai.run.context import RunContext
from bocchi.services.ai.tools.core.toolkit import BaseToolkit
from bocchi.services.ai.tools.models import Query, ResolvedToolPayload
...
class _StringResolver:
    ...
    async def resolve(self, context: RunContext | None = None) -> ResolvedToolPayload:
        ...
        from bocchi.services.ai.tools.models import Query
