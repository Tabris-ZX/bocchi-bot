...
from bocchi.services.ai.core.messages import AnyLLMMessage, LLMMessage, ToolCallPart
...
from bocchi.services.ai.tools.models import (
    StateSyncResult,
    ToolOptions,
    ToolResult,
    ToolResultChunk,
...
if TYPE_CHECKING:
    ...
    from bocchi.services.ai.tools.engine.registry import ToolCollection
...
class ToolExecutor:
    ...
    async def execute_tool_call(
        ...
        from bocchi.services.ai.run.context import set_run_context
...
from bocchi.services.ai.tools.core.tool import register_tool_runner
