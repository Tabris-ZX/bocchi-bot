...
from bocchi.services.ai.core.stream_events import ToolStreamChunkEvent, UserCustomEvent
from bocchi.services.ai.run.context import RunContext
from bocchi.services.ai.run.di import Inject
from bocchi.services.ai.sandbox.models import (
    SandboxBlueprint,
)
from bocchi.services.ai.tools.core.decorators import Rules, tool
...
class SandboxToolkit(BaseToolkit):
    ...
    async def execute_code(
        ...
        from bocchi.services.ai.sandbox.runtimes import CodeExecutorRegistry
        ...
        if CodeExecutorRegistry._normalize_lang(language) not in supported:
            from bocchi.services.ai.core.exceptions import ToolRetryError
