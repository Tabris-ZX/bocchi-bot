...
from bocchi.services.ai.core.stream_events import UserCustomEvent
from bocchi.services.ai.run.context import RunContext
from bocchi.services.ai.sandbox.addons.base import BaseMcpProxyExtension
from bocchi.services.ai.sandbox.models import SandboxBlueprint
from bocchi.services.ai.tools.core.tool import BaseTool
...
from bocchi.utils.lifespan import LifespanManager
...
class MCPRemoteTool(BaseTool):
    ...
    async def execute(self, context: RunContext | None = None, **kwargs) -> ToolResult:
        ...
        from bocchi.services.ai.core.messages import ImagePart, TextPart
                ...
                try:
                    ...
                    async with AsyncExitStack() as stack:
                        ...
                        if self.transport == "stdio":
                            ...
                            from bocchi.services.ai.sandbox.manager import (
                                sandbox_manager,
                            )
                    ...
                    from bocchi.services.ai.core.exceptions import SandboxFatalError
