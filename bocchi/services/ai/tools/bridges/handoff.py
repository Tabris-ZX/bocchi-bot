...
from bocchi.services.ai.tools.models import HandoffResult, ToolResult
...
class HandoffTool(BaseTool):
    ...
    def __init__(
        ...
        actual_schema = None
        if input_schema:
            from bocchi.services.ai.core.options import BaseOutputDefinition
    ...
    async def execute(
        ...
        from bocchi.services.ai.core.messages import HandoffEvent
