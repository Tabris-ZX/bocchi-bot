...
from bocchi.services.ai.capabilities import AbstractCapability
from bocchi.services.ai.run.context import RunContext
from bocchi.services.ai.tools.core.capabilities import (
...
from bocchi.services.ai.tools.models import ToolOptions
...
def toolkit(
    ...
    def decorator(cls):
        ...
        from bocchi.services.ai.tools.models import ToolkitConfig
...
def tool(
    ...
    def decorator(func: Callable):
        ...
        if is_method:
            ...
            from bocchi.services.ai.tools.core.tool import FunctionTool
            from bocchi.services.ai.tools.engine.registry import tool_provider_manager
...
def direct_reply() -> ToolOptions:
    ...
    class DirectReplyCapability(AbstractCapability):
        async def wrap_tool_execute(self, context, tool_name, arguments, handler):
            ...
            from bocchi.services.ai.tools.models import EndRunResult, ToolResult
