...
from bocchi.services.ai.run.hitl import HITLController
from bocchi.services.ai.tools.models import ToolResult
from bocchi.services.ai.utils import PermissionUtils
from bocchi.services.log import logger
from bocchi.utils.pydantic_compat import model_dump, parse_as

_TOOL_RESULT_CACHE = SimpleMemoryCache(namespace="bocchi_tool_cache")
