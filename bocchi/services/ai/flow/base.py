...
from bocchi.services.ai.run.ui import UIController

if TYPE_CHECKING:
    from bocchi.services.ai.flow.agent.models import Persona
    from bocchi.services.ai.run.models import StreamedRunResult
...
class BaseRunnable(ABC, Generic[T_RunResult]):
    ...
    def bind(self, **kwargs: Any) -> Any:
        ...
        from bocchi.services.ai.flow.agent.bridge import AgentRunner
