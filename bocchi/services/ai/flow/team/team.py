...
from bocchi.services.ai.capabilities import AbstractCapability, DynamicCapability
from bocchi.services.ai.core.exceptions import ConcurrencyInterruptException
from bocchi.services.ai.core.messages import PromptInput
from bocchi.services.ai.core.models import CancellationToken
from bocchi.services.ai.core.stream_events import EventBus
from bocchi.services.ai.flow.agent.agent import CapabilitySource, ToolSource
from bocchi.services.ai.flow.agent.models import Persona
from bocchi.services.ai.flow.base import BaseRunnable
from bocchi.services.ai.flow.team.models import TeamRuntimeConfig, Transition
from bocchi.services.ai.flow.team.router import BaseRouter
from bocchi.services.ai.flow.team.strategy import (
    BaseTeamStrategy,
)
from bocchi.services.ai.run import AgentRunResult, AgentTask, RunContext
...
class Team(BaseRunnable[AgentRunResult[Any]]):
    ...
    def with_routing(
        ...
        """
        from bocchi.services.ai.flow.team.strategy import RouteStrategy
    ...
    def with_coordination(
        ...
        """
        from bocchi.services.ai.flow.team.strategy import CoordinateStrategy
    ...
    def with_broadcast(
        ...
        """
        from bocchi.services.ai.flow.team.strategy import BroadcastStrategy
    ...
    def with_task(
        ...
        """
        from bocchi.services.ai.flow.team.strategy import TaskStrategy
    ...
    async def run_stream(
        ...
        **kwargs: Any,
        ...
        from bocchi.services.ai.flow.team.runner import TeamRunner
        from bocchi.services.ai.run import StreamedRunResult
        ...
        if policy is None:
            from bocchi.services.ai.flow.base import ConcurrencyPolicy
        ...
        async def _execution_task():
            ...
            try:
                ...
                from bocchi.services.ai.run.models import AgentRunError
