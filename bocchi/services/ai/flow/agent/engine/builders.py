...
from bocchi.services.ai.context.memory.engine import MemoryReader, MemoryWriter
from bocchi.services.ai.context.memory.models import MemoryConfig
from bocchi.services.ai.context.memory.types import SessionMetadata
from bocchi.services.ai.core.messages import LLMMessage, TextPart
from bocchi.services.ai.core.options import GenerationConfig
from bocchi.services.ai.core.templates import PromptTemplate
from bocchi.services.ai.flow.agent.capabilities import (
    OutputValidationCapability,
    TaskTrackingCapability,
)
from bocchi.services.ai.flow.agent.models import Persona
from bocchi.services.ai.run import GLOBAL_CAPABILITIES, RunContext
from bocchi.services.ai.run.di import DependencyInjector
from bocchi.services.ai.tools.engine.registry import (
    ToolCollection,
    tool_provider_manager,
)
from bocchi.services.ai.tools.models import GlobalToolFilter, ResolvedToolPayload
from bocchi.services.ai.utils.scope import ScopeSelector
from bocchi.utils.pydantic_compat import model_copy
