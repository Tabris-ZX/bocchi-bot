...
from bocchi.services.ai.context.rag.configs import RAGConfig
from bocchi.services.ai.context.rag.engine import ScopedRAGClient
from bocchi.services.ai.context.rag.ingestion import (
    ChunkingStrategy,
    DedupNode,
    DocumentChunking,
    DynamicChunkingNode,
...
from bocchi.services.ai.context.rag.retrieval import (
    BaseRetriever,
...
class RAGBuilder:
    ...
    def build(self) -> ScopedRAGClient:
        ...
        if not embedder:
            from bocchi.services.ai.context.rag.backends import DefaultEmbedder
