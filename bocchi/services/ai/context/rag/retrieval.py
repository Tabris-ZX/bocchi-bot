...
from bocchi.services.ai.context.rag.models import QueryRequest, SearchResult
from bocchi.services.log import logger

if TYPE_CHECKING:
    from bocchi.services.ai.context.rag.backends.storages import StorageBackend
...
class RerankRetriever(BaseRetriever):
    ...
    async def retrieve(
        ...
        from bocchi.services.ai.llm.api import rerank
