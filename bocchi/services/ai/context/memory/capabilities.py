...
from bocchi.services.ai.capabilities.base import AbstractCapability
from bocchi.services.ai.context.memory.models import MemoryConfig
from bocchi.services.ai.run.context import RunContext
from bocchi.services.ai.tools.providers.builtin.memory import MemoryManagementToolkit
...
class SlotMemoryCapability(AbstractCapability):
    ...
    async def get_tools(self, context: RunContext) -> list[Any]:
        from bocchi.services.ai.tools.providers.builtin.slots import MemorySlotToolkit
