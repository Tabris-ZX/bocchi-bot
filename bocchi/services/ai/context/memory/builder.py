...
if TYPE_CHECKING:
    from bocchi.services.ai.context.memory.models import MemorySlot
...
from bocchi.services.ai.context.memory.compression import MemoryPolicy
from bocchi.services.ai.context.memory.models import (
...
from bocchi.services.ai.utils.scope import ScopeBuilder
