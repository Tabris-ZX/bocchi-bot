...
from bocchi.services.ai.context.knowledge.readers import (
    BaseReader,
    CSVReader,
    TextReader,
)
from bocchi.services.ai.context.rag.engine import ScopedRAGClient
from bocchi.services.ai.context.rag.models import BaseRecord
from bocchi.services.ai.core.messages import LLMMessage
from bocchi.services.ai.llm.api import generate_structured
from bocchi.services.ai.run import RunContext
from bocchi.services.ai.tools.core.decorators import tool
from bocchi.services.ai.tools.models import ToolkitConfig, ToolResult
...
class VectorKnowledge(BaseKnowledge):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if rag_client is None:
            from bocchi.services.ai.context.rag.backends import DictStorageBackend
            from bocchi.services.ai.context.rag.builder import RAGBuilder
    ...
    def from_event(
        ...
        **kwargs,
        ...
        """
        from bocchi.services.ai.context.memory.types import Isolation
        from bocchi.services.ai.context.rag.backends import DictStorageBackend
        from bocchi.services.ai.context.rag.builder import RAGBuilder
        from bocchi.services.ai.run.context import NoneBotDeps
