...
from bocchi.services.ai.core.exceptions import SandboxPathEscapeError, WorkspaceIOError
...
from bocchi.services.ai.sandbox.storage import RESOLVE_PATH_HELPER, coerce_posix_path
...
class DockerSandboxClient(BaseSandboxClient):
        ...
        async with self._init_lock:
            ...
            if eff_cname not in DockerSandboxClient._containers:
                ...
                container_config = {
                    ...
                    "Labels": {
                        "bocchi_component": "sandbox",
                        "bocchi_container_name": eff_cname,
                    },
                }
    ...
    async def delete(self, session: BaseSandboxSession) -> None:
        ...
        from bocchi.services.ai.sandbox.manager import sandbox_manager
        ...
        try:
            async with aiodocker.Docker() as docker:
                ...
                containers = await docker.containers.list(
                    filters={"label": ["bocchi_component=sandbox"]}, all=True
                )
                count = 0
                for c in containers:
                    try:
...
from bocchi.services.ai.sandbox.registry import SandboxRegistry
