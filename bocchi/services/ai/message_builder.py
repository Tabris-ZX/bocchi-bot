...
from bocchi.utils.pydantic_compat import TypeAdapter, model_copy, model_dump
...
class MessageBuilder:
    ...
    async def normalize_to_llm_messages(
        ...
        try:
            ...
            if not bot_inst or not event_inst:
                try:
                    from bocchi.services.ai.run import get_current_run_context
        ...
        if not converted:
            if isinstance(message, LLMMessage):
                ...
                from bocchi.services.ai.core.engine.context_renderer import (
                    ContextConverter,
                )
    ...
    async def normalize_to_embed_batch(
        ...
        from bocchi.services.ai.core.messages import BaseContentPart, TextPart
