...
from bocchi.services.ai.utils import PermissionUtils
...
class ToolRetryAndReflectionCapability(AbstractCapability):
    ...
    async def wrap_tool_execute(
        ...
        try:
            ...
            from bocchi.services.ai.tools.engine.executor import ToolExecutionPolicy
...
**修正要求：** 请结合上述反馈报告，反思你的决策逻辑或内容生成，在保持数据格式正确的前提下，重新生成符合护栏规范的内容。"""  # noqa: E501
    ...
    async def wrap_model_request(
        ...
        from bocchi.services.ai.guardrails import GuardrailPipeline
