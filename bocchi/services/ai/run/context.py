...
from bocchi.services.ai.core.messages import AgentEvent, AgentMessage
...
class SessionContext(Generic[AgentDepsT]):
    ...
    def memory(self) -> Any:
        ...
        """
        from bocchi.services.ai.context.memory.facades import AgentSessionFacade
...
class RunContext(Generic[AgentDepsT]):
    ...
    def __post_init__(self):
        ...
        if not self.session_id and self.deps:
            from bocchi.services.ai.context.memory.types import (
                Isolation,
            )
        ...
        from bocchi.services.ai.core.engine.append_only import (
